...
> **Don't need `/ask-gpt` or `/ask-gemini`?** Skip this entirely. No other command needs API keys. (`/review-browser` has its own optional Playwright install - see [Full Setup](README.md#full-setup-all-features) - but no key.)
