...
echo "    Claude Code users: since v7.0.0 the toolkit is also a plugin. Prefer it over this copy:"
echo "      /plugin marketplace add mayankmankhand/llm-peer-review, /plugin install tk@llm-peer-review,"
echo "      then /tk:setup in this project (it migrates this copy and keeps your custom files)."
echo ""
