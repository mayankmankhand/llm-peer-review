...
- **Findings are ranked by locus, not by the severity label** that `severity-anchors.md` already calls unreliable in both directions. Specialist groups collapse into one ranked list; a real artifact had rendered a Suggest above eight Warns.
