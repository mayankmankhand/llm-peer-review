...
description: The copy review criteria, reading budget, severity anchors, finding ids, and finding contract, preloaded into the review-copy-finder agent. Not a command; the direct-run skill is /review-copy.
