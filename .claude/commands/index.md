...
> "Your project has ~{totalTokens} tokens across {totalFiles} files. Generating the codebase map will spawn {chunks.length} parallel subagents (Sonnet via general-purpose subagent). Estimated one-time cost: a few dollars. Proceed?"
