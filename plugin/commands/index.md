---
description: "Codebase Map Generator (Index)"
allowed-tools:
  - "Bash(node ${CLAUDE_PLUGIN_ROOT}/scripts/generate-index.js *)"
  - "Bash(node ${CLAUDE_PLUGIN_ROOT}/scripts/generate-index.js)"
---
...
```
node ${CLAUDE_PLUGIN_ROOT}/scripts/generate-index.js
```
...
> Semantic map generated by `/tk:index`, refreshed by `/tk:document`.
> If HEAD has moved since the commit above, this map may be stale - run `/tk:index` to refresh.
