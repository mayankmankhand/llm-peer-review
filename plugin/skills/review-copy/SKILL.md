...
**Important:** This skill reviews whether content orients a fresh reader. It does not review usability, accessibility, or interaction design - use `/tk:review-ux` for those.
