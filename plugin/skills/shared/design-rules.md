...
```
node ${CLAUDE_PLUGIN_ROOT}/scripts/gen-media.js --kind image --prompt "<prompt>" --out <asset dir>/<surface>-<name>.png
node ${CLAUDE_PLUGIN_ROOT}/scripts/gen-media.js --kind video --prompt "<prompt>" [--image <still>] --out <asset dir>/<surface>-<name>.mp4
