...
This agent declares no model, so it runs on the session model: a scoring critic whose verdict is final is a judge, and judges inherit per `${CLAUDE_PLUGIN_ROOT}/skills/shared/model-routing.md`.
