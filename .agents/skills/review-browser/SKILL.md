...
---
<!-- GENERATED by node .claude/scripts/build-layouts.js from .claude/skills/review-browser/SKILL.md. Do not edit: change the source under .claude/ and rebuild. -->
...
> Read `.claude/skills/shared/browse-api.md` now, before continuing. It is part of this skill and is not inlined here.
