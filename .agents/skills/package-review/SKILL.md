---
name: package-review
description: "Bundling code into a single markdown file for external AI review (paste into ChatGPT or Gemini directly). Not when: You want an automated multi-round debate (use `/ask-gpt` or `/ask-gemini`)."
---
<!-- GENERATED by node .claude/scripts/build-layouts.js from .claude/commands/package-review.md. Do not edit: change the source under .claude/ and rebuild. -->
