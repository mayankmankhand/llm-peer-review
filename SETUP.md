...
- Install from [nodejs.org](https://nodejs.org) (LTS is the stable long-term version, which is fine), then reopen your terminal. Use Node.js 22 or newer: from 7.3.1 the debate scripts' OpenAI library needs it
- Verify:
  ```powershell
  node -v
  npm -v
