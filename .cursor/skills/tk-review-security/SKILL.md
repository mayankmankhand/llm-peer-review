...
---
<!-- GENERATED by node .claude/scripts/build-layouts.js from .claude/skills/review-security/SKILL.md. Do not edit: change the source under .claude/ and rebuild. -->

Alias of `/review-security` for Cursor, where a built-in skill shadows that name. Same body, same rules.
...
> Read `.claude/skills/shared/do-not-report.md` now, before continuing. It is part of this skill and is not inlined here.
